...
export default function App() {
  const names = ["Afra", "Abrar", "Shahad", "Norah", "Abdullah", "Mohammed", "Saleh", "Ghada", "Sana","Fai"]
  ...
  return (
    ...
    <Text style={{marginTop: 10, fontWeight: "bold"}}>Frinds</Text>
    <View>
    ...
    <Text style={{marginTop: 10, fontWeight: "bold"}}>Trend</Text>
    <View>
